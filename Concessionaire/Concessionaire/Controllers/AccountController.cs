...
namespace Concessionaire.Controllers
{
    public class AccountController : Controller
    {
        ...
        //TODO verification users storage blob line 89
        [HttpPost]
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Response response = _mailHelper.SendMail(
                    ...
                    model.Username,
                    "Concesionario JuanAutos - Confirmación de Email",
                    $"<h1>Concesionario JuanAutos - Confirmación de Email</h1>" +
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                _mailHelper.SendMail(
                    $"{user.FullName}",
                    model.Email,
                    "Concesionario JuanAutos - Recuperación de Contraseña",
        ...
        public async Task<IActionResult> ResendToken(ResendTokenViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                ViewBag.Message.Danger(response.Message);
            }
            return View(model);
        }
